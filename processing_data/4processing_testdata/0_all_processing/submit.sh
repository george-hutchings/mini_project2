#!/bin/bash
#SBATCH --job-name=4_all  # job name, you can change this to any name to recongnise in slurm
...
#SBATCH --time=20:00:00      # Time limit for your job, hrs:min:sec
